    ...
    public class Startup
    {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1",
                    new OpenApiInfo
                    {
                        Title = "AutoGlass",
                        Version = "v1",
                        Description = "Desafio prático de Programação - Autoglass",
                        Contact = new OpenApiContact
                        {
                            Name = "Contact",
                            Url = new Uri("https://www.autoglass.com.br/")
                        }
                    });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Autoglass Product"));
            }
